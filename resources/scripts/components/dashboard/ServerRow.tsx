                    ...
                    <React.Fragment>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.Cpu size={20} css={tw`text-neutral-300`} />
                        ...
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.PieChart size={20} css={tw`text-neutral-300`} />
                ...
                <div css={tw`hidden col-span-12 sm:flex items-baseline justify-center items-center`}>
                    <React.Fragment>
                        <div css={tw`flex-1 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.HardDrive size={20} css={tw`text-neutral-300`} />
                                <IconDescription>{bytesToString(stats?.diskUsageInBytes)}</IconDescription>
                            </div>
                        </div>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.Clock size={20} css={tw`text-neutral-300`} />
                                <IconDescription>
                        ...
                        <div css={tw`flex-1 ml-12 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.DownloadCloud size={20} css={tw`text-neutral-300`} />
                                <IconDescription>{bytesToString(stats?.networkRxInBytes)}</IconDescription>
                            </div>
                        </div>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.UploadCloud size={20} css={tw`text-neutral-300`} />
